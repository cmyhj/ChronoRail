...
import { X, Clock, Calendar, Gamepad2, Plus, RefreshCw } from 'lucide-react';
      ...
      <div className="absolute right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-[#16162a] border-l border-[#2d2d4a] shadow-2xl animate-slide-in">
        ...
        <div className="p-4 border-b border-[#2d2d4a]">
          ...
          <ul className="space-y-1">
            {games.map((game) => (
              <li key={game.id}>
                <div
                  className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[#94a3b8] hover:text-[#e2e8f0] hover:bg-[#252540] transition-colors"
        ...
        <div className="p-4">
          ...
          <a
            ...
            className="flex items-center gap-3 w-full px-3 py-3 text-sm text-[#94a3b8] hover:text-[#e2e8f0] hover:bg-[#252540] rounded-lg transition-colors mt-1"
          >
