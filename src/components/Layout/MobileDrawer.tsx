...
import { X, Clock, Calendar, Gamepad2, Plus, RefreshCw, Check, AlertCircle, Download } from 'lucide-react';
      ...
      <div className="absolute right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-[#16162a] border-l border-[#2d2d4a] shadow-2xl animate-slide-in-right">
        ...
        <div className="p-4">
          <button
            ...
            disabled={syncing}
            className={`flex items-center gap-3 w-full px-3 py-3 rounded-lg text-sm font-medium transition-all duration-300 ${
              syncing
                ? 'bg-[#6366f1]/20 text-[#6366f1] cursor-wait'
                : 'bg-gradient-to-r from-[#6366f1] to-[#818cf8] text-white hover:from-[#4f46e5] hover:to-[#6366f1]'
            }`}
          >
          ...
          <a
            ...
            className="flex items-center gap-3 w-full px-3 py-3 text-sm text-[#94a3b8] hover:text-[#e2e8f0] hover:bg-[#252540] rounded-lg transition-colors mt-2"
          >
